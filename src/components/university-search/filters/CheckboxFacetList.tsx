            ...
            return (
              <li key={option}>
                <button
                  ...
                  className="flex min-h-[40px] w-full items-center gap-3 rounded-xl px-2 py-1.5 text-left text-sm transition-colors cursor-pointer hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
                >
                  <span
                    aria-hidden
                    className={cn(
