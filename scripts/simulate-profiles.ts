  ...
  // Singapore international school. Real admissions: Imperial EEE accepts IB 40-42 regularly.
  {
    ...
    profile: {
      ...
      lifestyle_preference: {
        ...
        epq_subject: null, epq_title: null, ambition_statement: 'To design sustainable electrical systems.',
      },
    },
  },
  ...
  // UK boarding school. A*A*A* in Maths, Physics, Further Maths. Real outcome: Imperial Mech Eng.
  {
    ...
    profile: {
      ...
      lifestyle_preference: {
        ...
        epq_subject: null, epq_title: null, ambition_statement: 'Aerospace mechanical engineering.',
      },
    },
  },
  ...
  // FINDING: Even IB 44 students are excluded from Harvard due to prestige penalty.
  {
    ...
    profile: {
      ...
      lifestyle_preference: {
        ...
        epq_subject: null, epq_title: null, ambition_statement: 'Advance artificial intelligence research.',
      },
    },
  },
  ...
  // Brazilian student at international school. Edinburgh Econ min IB 37. Should be Reach.
  {
    ...
    profile: {
      ...
      lifestyle_preference: {
        ...
        work_experience: false, work_experience_summary: null,
        epq_subject: null, epq_title: null, ambition_statement: 'Work at IMF or World Bank.',
      },
    },
  },
  ...
  // US private school. ACT 35 → IB equiv 43. Columbia min IB 43. effGap = 43-43=0, penalty=1.95 → effGap=-1.95 → Reach.
  {
    ...
    profile: {
      ...
      lifestyle_preference: {
        ...
        epq_subject: null, epq_title: null, ambition_statement: 'Work in finance and economics.',
      },
    },
  },
  ...
  // UK student. A*A*A* in Maths, History, Economics. IB equiv 43. Edinburgh PPE min IB 39. Should be Target.
  {
    ...
    profile: {
      ...
      lifestyle_preference: {
        ...
        intl_experience: [],
        work_experience: false, work_experience_summary: null,
        epq_subject: null, epq_title: null, ambition_statement: 'Civil service or international policy.',
      },
    },
  },
  ...
  // UK student. A*AB in Chem, Bio, Maths. IB equiv = 40. Edinburgh Medicine min IB 38. Target.
  {
    ...
    profile: {
      ...
      lifestyle_preference: {
        ...
        epq_subject: null, epq_title: null, ambition_statement: 'Become a paediatric doctor.',
      },
    },
  },
  ...
  // Real: Edinburgh does admit students 1 point below stated minimum sometimes.
  {
    ...
    profile: {
      ...
      lifestyle_preference: {
        ...
        epq_subject: null, epq_title: null, ambition_statement: 'Build a tech company.',
      },
    },
  },
  ...
  // This exposes the key calibration issue: NYU accepts ACT ~29-33 mid-50%.
  {
    ...
    profile: {
      ...
      lifestyle_preference: {
        ...
        intl_experience: [],
        work_experience: false, work_experience_summary: null,
        epq_subject: null, epq_title: null, ambition_statement: 'Quantitative analyst at a top bank.',
      },
    },
  },
  ...
  // Indian student. IB 34. Manchester Engineering is more accessible. Should be Target/Safety.
  {
    ...
    profile: {
      ...
      lifestyle_preference: {
        ...
        intl_experience: [],
        work_experience: false, work_experience_summary: null,
        epq_subject: null, epq_title: null, ambition_statement: 'Engineer sustainable vehicles.',
      },
    },
  },
];
...
export const BATCH_30_EXTRA: SimulatedProfile[] = [
  ...
  // ── 11. IB 39 → King's CS (min 39, score 80) ─────────────────────────────
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'academic', desired_location_type: 'london', campus_size: 'medium', extracurricular_interests: ['Coding'], other_extracurriculars: null, leadership_roles: [], commitment_level: 'moderate', key_activities: ['Coding club', 'Maths competition'], sat_score: null, act_score: null, intl_experience: [], work_experience: false, work_experience_summary: null, epq_subject: null, epq_title: null, ambition_statement: 'Build software products.' },
    },
  },
  ...
  // ── 13. IB 39 → Durham Economics (min 37, score 83) ──────────────────────
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'academic', desired_location_type: 'smaller_city', campus_size: 'medium', extracurricular_interests: ['Finance', 'Tennis'], other_extracurriculars: null, leadership_roles: [], commitment_level: 'moderate', key_activities: ['Finance club', 'Maths competition'], sat_score: null, act_score: null, intl_experience: ['Study abroad'], work_experience: false, work_experience_summary: null, epq_subject: null, epq_title: null, ambition_statement: 'Finance career in London.' },
    },
  },
  ...
  // ── 14. A*A*A* → UCL Economics (min 39, score 91) ─────────────────────────
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'academic', desired_location_type: 'london', campus_size: 'large', extracurricular_interests: ['Finance', 'Piano'], other_extracurriculars: null, leadership_roles: ['Head Boy / Girl'], commitment_level: 'deep', key_activities: ['Economics olympiad', 'Student council', 'Debate'], sat_score: null, act_score: null, intl_experience: ['Study abroad', 'International competition'], work_experience: true, work_experience_summary: 'Economics research assistant at university lab.', epq_subject: null, epq_title: null, ambition_statement: 'Become a leading economist.' },
    },
  },
  ...
  // ── 17. IB 38 → King's Law (min 38, score 76) ────────────────────────────
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'academic', desired_location_type: 'london', campus_size: 'medium', extracurricular_interests: ['MUN', 'Debate'], other_extracurriculars: null, leadership_roles: ['Community Leader'], commitment_level: 'deep', key_activities: ['Debate club', 'Model UN', 'Human rights society'], sat_score: null, act_score: null, intl_experience: ['International competition', 'Study abroad'], work_experience: false, work_experience_summary: null, epq_subject: null, epq_title: null, ambition_statement: 'Argue human rights cases at the ICJ.' },
    },
  },
  ...
  // ── 18. IB 40 → Imperial Biomedical Engineering (min 39, score 91) ────────
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'academic', desired_location_type: 'london', campus_size: 'medium', extracurricular_interests: ['Medical research', 'Cycling'], other_extracurriculars: null, leadership_roles: [], commitment_level: 'deep', key_activities: ['Science fair', 'Biology olympiad', 'Hospital volunteering'], sat_score: null, act_score: null, intl_experience: ['Study abroad'], work_experience: true, work_experience_summary: 'Research internship in biomedical engineering lab.', epq_subject: null, epq_title: null, ambition_statement: 'Design next-generation prosthetics.' },
    },
  },
  ...
  // ── 19. A*A*A* → Edinburgh Medicine (min 38, UCAT) — Safety expected ─────
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'academic', desired_location_type: 'major_city', campus_size: 'large', extracurricular_interests: ['Medicine', 'Volunteering'], other_extracurriculars: null, leadership_roles: ['Community Leader'], commitment_level: 'exceptional', key_activities: ['Hospital volunteering', 'Medical society', 'Science research', 'First aid', 'Tutoring'], sat_score: null, act_score: null, intl_experience: ['Volunteering abroad'], work_experience: true, work_experience_summary: 'Extensive clinical shadowing at two NHS hospitals.', epq_subject: null, epq_title: null, ambition_statement: 'Become a cardiothoracic surgeon.' },
    },
  },
  ...
  // ── 20. IB 37 → Edinburgh Law (min 37, score 83) ─────────────────────────
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'academic', desired_location_type: 'major_city', campus_size: 'large', extracurricular_interests: ['Law debate', 'MUN'], other_extracurriculars: null, leadership_roles: [], commitment_level: 'moderate', key_activities: ['Moot court', 'Model UN'], sat_score: null, act_score: null, intl_experience: ['International competition'], work_experience: false, work_experience_summary: null, epq_subject: null, epq_title: null, ambition_statement: 'International arbitration practice.' },
    },
  },
  ...
  // Real: Cornell ACT mid-50% is 34-36.
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'practical', desired_location_type: 'major_city', campus_size: 'large', extracurricular_interests: ['Competitive programming', 'Basketball'], other_extracurriculars: null, leadership_roles: ['Club Founder'], commitment_level: 'exceptional', key_activities: ['Competitive programming', 'Hackathon', 'Research internship', 'Tutoring', 'Open source'], sat_score: 1520, act_score: 34, intl_experience: [], work_experience: true, work_experience_summary: 'Software engineering internship building computer science tools.', epq_subject: null, epq_title: null, ambition_statement: 'Build impactful software products.' },
    },
  },
  ...
  // ── 23. IB 43 → Columbia CS (min 43, score 92) — Reach ───────────────────
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'academic', desired_location_type: 'major_city', campus_size: 'large', extracurricular_interests: ['AI', 'Startup'], other_extracurriculars: null, leadership_roles: ['Class President'], commitment_level: 'exceptional', key_activities: ['Hackathon', 'Competitive programming', 'Startup project', 'Research', 'Volunteering'], sat_score: null, act_score: null, intl_experience: ['International competition', 'Study abroad'], work_experience: true, work_experience_summary: 'Founded a software startup developing computer science tools.', epq_subject: null, epq_title: null, ambition_statement: 'Build a tech company.' },
    },
  },
  ...
  // ── 25. IB 36 → McGill University (no min IB — tier implied) ─────────────
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'academic', desired_location_type: 'major_city', campus_size: 'large', extracurricular_interests: ['Economics', 'Violin'], other_extracurriculars: null, leadership_roles: [], commitment_level: 'moderate', key_activities: ['Economics club', 'Math competition'], sat_score: null, act_score: null, intl_experience: ['Study abroad'], work_experience: false, work_experience_summary: null, epq_subject: null, epq_title: null, ambition_statement: 'Work at Statistics Canada or the Bank of Canada.' },
    },
  },
  ...
  // ── 26. A*A*A → UBC Engineering (no min IB) ───────────────────────────────
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'practical', desired_location_type: 'major_city', campus_size: 'large', extracurricular_interests: ['Hockey', 'Engineering'], other_extracurriculars: null, leadership_roles: [], commitment_level: 'moderate', key_activities: ['Robotics club', 'Physics competition'], sat_score: null, act_score: null, intl_experience: [], work_experience: false, work_experience_summary: null, epq_subject: null, epq_title: null, ambition_statement: 'Build infrastructure in western Canada.' },
    },
  },
  ...
  // ABB → IB equiv: sum=6+5+5=16 → IB=24+(10/15)*19≈37. gap=37-36=1, prestige=1.18, effGap=-0.18 → Reach.
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'academic', desired_location_type: 'smaller_city', campus_size: 'medium', extracurricular_interests: ['Biology', 'Football'], other_extracurriculars: null, leadership_roles: [], commitment_level: 'moderate', key_activities: ['Science club', 'Biology competition'], sat_score: null, act_score: null, intl_experience: [], work_experience: false, work_experience_summary: null, epq_subject: null, epq_title: null, ambition_statement: 'Discover new drug compounds.' },
    },
  },
  ...
  // gap = -1, prestige penalty = (68.29-65)/35*2.5 = 0.24, effGap = -1.24 → Reach.
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'practical', desired_location_type: 'london', campus_size: 'medium', extracurricular_interests: ['Robotics', 'Swimming'], other_extracurriculars: null, leadership_roles: [], commitment_level: 'moderate', key_activities: ['Science fair', 'Biology club'], sat_score: null, act_score: null, intl_experience: ['Study abroad'], work_experience: false, work_experience_summary: null, epq_subject: null, epq_title: null, ambition_statement: 'Improve prosthetic devices.' },
    },
  },
  ...
  // ── 30. IB 31 → University of Manchester Business (easier tier) ───────────
  {
    ...
    profile: {
      ...
      activities_list: [],
      lifestyle_preference: { teaching_style: 'mixed', desired_location_type: 'major_city', campus_size: 'large', extracurricular_interests: ['Football', 'Business'], other_extracurriculars: null, leadership_roles: [], commitment_level: 'moderate', key_activities: ['Business club', 'Entrepreneurship competition'], sat_score: null, act_score: null, intl_experience: ['Study abroad'], work_experience: true, work_experience_summary: 'Part-time work at family business. Managed business operations and customer service.', epq_subject: null, epq_title: null, ambition_statement: 'Grow a European tech company.' },
    },
  },
];
  ...
  return {
    ...
    profile: {
      ...
      lifestyle_preference: {
        ...
        epq_subject: null, epq_title: null, ambition_statement: null,
      },
    },
  };
}
...
async function fetchCoursesForUniversity(
  ...
  return programs.map(p => {
    ...
    return {
      ...
      // uniData.acceptance_rate_pct is already a number; the parseFloat() here was
      // a type error hidden by scripts/ being excluded from tsconfig.
      acceptance_rate_pct: uniData?.acceptance_rate_pct ?? null,
