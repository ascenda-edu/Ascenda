            ...
            <div className="space-y-2 border-t border-border/60 pt-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-full bg-feature px-3.5 py-1.5 text-xs font-semibold text-feature-foreground transition hover:-translate-y-0.5 hover:bg-feature/90 disabled:opacity-50"
                >
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="mt-4 flex w-full items-center justify-center gap-2 rounded-full bg-feature px-4 py-2.5 text-sm font-semibold text-feature-foreground transition hover:-translate-y-0.5 hover:bg-feature/90 disabled:opacity-50"
              >
