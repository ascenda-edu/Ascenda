              ...
              <div key={msg.id} className={cn('flex', isParent ? 'justify-end' : 'justify-start')}>
                ...
                >
                  ...
                  <div className={cn('mt-1 flex items-center gap-1', isParent ? 'justify-end' : 'justify-start')}>
                    <span className={cn('text-[10px]', isParent ? 'text-primary-foreground/60' : 'text-muted-foreground')}>
      ...
      <div className="flex flex-wrap gap-2 border-t border-border/50 px-4 py-2">
        {TEMPLATES.map((t) => (
          <button
            ...
            className="rounded-full bg-muted/50 px-3 py-1 text-[10px] font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
          >
            {t.label}
          </button>
        ))}
