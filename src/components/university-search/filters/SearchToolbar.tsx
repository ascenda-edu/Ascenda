      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="relative inline-flex h-11 min-h-[44px] items-center gap-2 rounded-full border border-primary bg-transparent px-4 text-sm font-medium text-primary-ink transition-[box-shadow,border-color,background-color] duration-200 cursor-pointer hover:bg-primary/10 hover:shadow-e-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 lg:hidden"
          >
